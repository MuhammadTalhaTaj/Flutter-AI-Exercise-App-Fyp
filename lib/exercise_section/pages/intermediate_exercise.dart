...
class IntermediateExercisesScreen extends StatelessWidget {
  const IntermediateExercisesScreen({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: const UpperContainer(title: 'Intermediate',describe: 'Become Stronger',),
              ),
